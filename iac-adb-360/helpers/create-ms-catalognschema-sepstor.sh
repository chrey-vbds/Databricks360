...
echo "Resourcegroup: $resourcegroupname as parm 1"
...
echo "Clientid: $clientid as parm 3"
clientsecret=$4 #'<<none>>'
echo "Secret: $clientsecret as parm 4"
metastorename=$5
echo "metastorename: $metastorename as parm 5"
env=$6
echo "environment: $env as parm 6"
storageaccountname=$7
echo "Catalogstorage: $storageaccountname as parm 7"
credname=$8
echo "CredentialName: $credname as parm 8"
accessconnectorid=$9
echo "AccessconnectorID: $accessconnectorid as parm 9"
