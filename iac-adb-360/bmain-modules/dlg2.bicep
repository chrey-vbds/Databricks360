...
var curatedDlgName = substring('y${substring(tempdlgname, 0, 20)}${uniqueString(tempdlgname)}', 0, 24)
var tempmetastorename = 'dlg2metastore${env}${location}${baseName}'
var curatedMetaStorename = substring('y${substring(tempmetastorename, 0, 20)}${uniqueString(tempmetastorename)}', 0, 24)
